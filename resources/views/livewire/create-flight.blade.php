<form class="md:w-3/4" wire:submit.prevent='createFlight'>
    <div class="space-y-4 mb-6">
        ...
        <div>
            ...
            <x-text-input id="total_seats" class="block mt-1 w-full" type="number" wire:model="total_seats" :value="old('total_seats')" />
